...
async fn fetch_query_map_stats(query: MapStatsQuery) -> Result<MapStatsTable, SwarmyTauriError> {
...
fn trigger_fetch_query_map_stats(data: Store<MapStatsTable>, query: ReadSignal<MapStatsQuery>) {
...
pub fn StatsByMap() -> impl IntoView {
    ...
    let map_stats_data = Store::new(MapStatsTable::default());
    view! {
